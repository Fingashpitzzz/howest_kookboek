...
<?php 
	...
	$sql= "SELECT * FROM gerechten WHERE categorie='vegetarisch' ORDER BY 'naam';";
	$result= mysql_query($sql);
?>

<html>
    <head>
        <title>Vegetarische gerechten</title>
    </head>
    ...
    <link type="text/css" rel="stylesheet" href="../opmaak.css" />
        ...
        <img border="0" src="../afbeeldingen/vegetarisch.jpg" height="200"/>
        <br><br>
