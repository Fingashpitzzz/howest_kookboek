...
<?php 
	...
	$sql= "SELECT * FROM gerechten WHERE soort='aperitiefhapje' ORDER BY 'naam';";
	$result= mysql_query($sql);
?>

<html>
    <head>
        <title>Aperitiefhapjes</title>
    </head>

    <link type="text/css" rel="stylesheet" href="../opmaak.css" />
        <h2>Aperitiefhapjes</h2>
        ...
        <img border="0" src="../afbeeldingen/aperitiefhapjes.jpg" height="200"/>
        <br><br>
